...
- SQL Server schema, migrations, seed data, CDC, triggers, and reporting objects
...
Before committing, check whether the change affects any of the following:

| Area | Question to Ask |
|---|---|
| Frontend | Did routes, forms, UI text, selectors, state, or page behaviour change? |
| Backend API | Did request/response fields, endpoints, auth, roles, or validation change? |
| SQL Server | Does the change need a migration, seed update, CDC change, trigger update, or reporting object update? |
...
| Documentation | Does README need the completed iteration, new commands, new endpoints, or changed workflow? |

### Preferred Flow After Every Iteration
...
### Important Lesson from the Azure DevOps Stabilisation

Local success is not enough.

The real definition of done for Wonderland is:
...
This protects the project from hidden drift between local SQL Server, GitHub CI, and Azure CI.
